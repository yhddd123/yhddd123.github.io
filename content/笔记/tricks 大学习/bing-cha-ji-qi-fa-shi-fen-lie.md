...
isTop: false
---
### 已完成今日 [并查集启发式分裂 (https://qoj.ac/submission/445313)](https://qoj.ac/submission/445313) 大学习。

> 保证每条边只加/删一次，且所有加的边形成森林，维护连通块信息，强制在线。

---

由于加边删边的特殊性，可以 $O(n\log^2 n)$ 启发式合并分裂。
...
例：[P11519](https://www.luogu.com.cn/problem/P11519)。